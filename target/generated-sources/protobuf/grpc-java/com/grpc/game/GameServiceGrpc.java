...
public final class GameServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.game.Die,
      com.grpc.game.GameState> getRollMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "roll",
      requestType = com.grpc.game.Die.class,
      responseType = com.grpc.game.GameState.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.grpc.game.Die,
      com.grpc.game.GameState> getRollMethod() {
    io.grpc.MethodDescriptor<com.grpc.game.Die, com.grpc.game.GameState> getRollMethod;
      ...
      synchronized (GameServiceGrpc.class) {
        if ((getRollMethod = GameServiceGrpc.getRollMethod) == null) {
          GameServiceGrpc.getRollMethod = getRollMethod = 
              io.grpc.MethodDescriptor.<com.grpc.game.Die, com.grpc.game.GameState>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "GameService", "roll"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.game.Die.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.game.GameState.getDefaultInstance()))
  ...
  public static abstract class GameServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.grpc.game.Die> roll(
        io.grpc.stub.StreamObserver<com.grpc.game.GameState> responseObserver) {
  ...
  private static abstract class GameServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.game.GameServiceOuterClass.getDescriptor();
    }
